...
/***/ function(module, exports) {
	...
	var _jeffreyrosenbluth$liarspoker$Types_ops = _jeffreyrosenbluth$liarspoker$Types_ops || {};
	_jeffreyrosenbluth$liarspoker$Types_ops['<*>'] = _elm_lang$core$Json_Decode$object2(
		F2(
			function (x, y) {
				return x(y);
			}));
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(model.turn)
						]))
				]));
	};
	var _jeffreyrosenbluth$liarspoker$GameInfo$multipleView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(model.multiple))
						]))
				]));
	};
	var _jeffreyrosenbluth$liarspoker$GameInfo$stakesView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.baseStake))
						]))
				]));
	};
	var _jeffreyrosenbluth$liarspoker$GameInfo$bidView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _jeffreyrosenbluth$liarspoker$GameInfo$bidderView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _jeffreyrosenbluth$liarspoker$GameInfo$handView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'L ',
								A2(_elm_lang$core$Basics_ops['++'], model.hand, ' P')))
						]))
				]));
	};
	var _jeffreyrosenbluth$liarspoker$GameInfo$currentPlayerView = function (model) {
		var icon = _elm_lang$core$Native_Utils.eq(model.name, model.turn) ? A2(
			_elm_lang$html$Html$i,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('fa fa-circle-o-notch fa-spin ml1 olive')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])) : A2(
			_elm_lang$html$Html$i,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('fa fa-circle-o-notch ml1 olive muted')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
		return A2(
	...
	var _jeffreyrosenbluth$liarspoker$GameInfo$view = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_jeffreyrosenbluth$liarspoker$GameInfo$currentPlayerView(model),
							_jeffreyrosenbluth$liarspoker$GameInfo$handView(model)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_jeffreyrosenbluth$liarspoker$GameInfo$multipleView(model)
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_jeffreyrosenbluth$liarspoker$GameInfo$bidView(model)
						]))
				]));
	};
	var _jeffreyrosenbluth$liarspoker$GameInfo$init = {
		name: '',
		turn: '',
		bidder: '',
		baseStake: 1,
	...
	var _jeffreyrosenbluth$liarspoker$GameInfo$Model = F7(
		function (a, b, c, d, e, f, g) {
			return {name: a, turn: b, bidder: c, baseStake: d, multiple: e, bid: f, hand: g};
		});
	...
	var _jeffreyrosenbluth$liarspoker$GamePlay$update = F2(
		function (msg, model) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'RaiseQuant':
	...
	var _jeffreyrosenbluth$liarspoker$GamePlay$Model = F4(
		function (a, b, c, d) {
			return {quant: a, rank: b, buttons: c, bid: d};
		});
	var _jeffreyrosenbluth$liarspoker$GamePlay$Outgoing = function (a) {
		return {ctor: 'Outgoing', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$GamePlay$playView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_jeffreyrosenbluth$liarspoker$GamePlay$Outgoing(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'bid ',
									A2(
	...
	var _jeffreyrosenbluth$liarspoker$GamePlay$RaiseRank = function (a) {
		return {ctor: 'RaiseRank', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$GamePlay$rankEntryView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _jeffreyrosenbluth$liarspoker$GamePlay$quantEntryView = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _jeffreyrosenbluth$liarspoker$PlayerList$scoreListView = function (model) {
	...
	var _jeffreyrosenbluth$liarspoker$PlayerList$bidder = function (model) {
		var b = A2(
			_elm_lang$core$Maybe$andThen,
			model.bidder,
			function (n) {
				return A2(_elm_lang$core$Array$get, n, model.players);
			});
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'None',
	...
	var _jeffreyrosenbluth$liarspoker$PlayerList$turn = function (model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'Error',
			A2(
				...
				A2(_elm_lang$core$Array$get, model.turn, model.players)));
	};
	var _jeffreyrosenbluth$liarspoker$PlayerList$playerListView = function (model) {
		var sty = function (x) {
			return _elm_lang$core$Native_Utils.eq(
				x,
				_jeffreyrosenbluth$liarspoker$PlayerList$bidder(model)) ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
				...
				x,
				_jeffreyrosenbluth$liarspoker$PlayerList$turn(model)) ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'width', _1: '45%'}
						]))
				]),
			ps);
	};
	var _jeffreyrosenbluth$liarspoker$PlayerList$markerListView = function (model) {
		var mark = function (x) {
			return _elm_lang$core$Native_Utils.eq(
				x,
				_jeffreyrosenbluth$liarspoker$PlayerList$turn(model)) ? A2(
				_elm_lang$html$Html$i,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('fa')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'width', _1: '5%'}
						]))
				]),
			ps);
	};
	var _jeffreyrosenbluth$liarspoker$PlayerList$view = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_jeffreyrosenbluth$liarspoker$PlayerList$markerListView(model),
					_jeffreyrosenbluth$liarspoker$PlayerList$playerListView(model),
					_jeffreyrosenbluth$liarspoker$PlayerList$scoreListView(model),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
	...
	var _jeffreyrosenbluth$liarspoker$PlayerList$init = {players: _elm_lang$core$Array$empty, bidder: _elm_lang$core$Maybe$Nothing, turn: 0};
	var _jeffreyrosenbluth$liarspoker$PlayerList$Model = F3(
		function (a, b, c) {
			return {players: a, bidder: b, turn: c};
		});

	var _jeffreyrosenbluth$liarspoker$SignIn$update = F2(
		function (msg, model) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'Name':
	...
	var _jeffreyrosenbluth$liarspoker$SignIn$init = {name: '', gameId: '', numPlayers: 0};
	var _jeffreyrosenbluth$liarspoker$SignIn$Model = F3(
		function (a, b, c) {
			return {name: a, gameId: b, numPlayers: c};
		});
	var _jeffreyrosenbluth$liarspoker$SignIn$NumPlayers = function (a) {
		return {ctor: 'NumPlayers', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$SignIn$Outgoing = function (a) {
		return {ctor: 'Outgoing', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$SignIn$startView = function (m) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
						...
						[
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$html$Html_Events$onClick(
											_jeffreyrosenbluth$liarspoker$SignIn$NumPlayers(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('btn btn-outline h6 m1'),
											_elm_lang$html$Html_Events$onClick(
											_jeffreyrosenbluth$liarspoker$SignIn$NumPlayers(m.numPlayers + 1))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('+')
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Events$onClick(
									_jeffreyrosenbluth$liarspoker$SignIn$Outgoing(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'new ',
											A2(
	...
	var _jeffreyrosenbluth$liarspoker$SignIn$GameId = function (a) {
		return {ctor: 'GameId', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$SignIn$joinView = function (m) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Events$onInput(_jeffreyrosenbluth$liarspoker$SignIn$GameId),
	...
	var _jeffreyrosenbluth$liarspoker$SignIn$Name = function (a) {
		return {ctor: 'Name', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$SignIn$nickView = function (m) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onInput(_jeffreyrosenbluth$liarspoker$SignIn$Name),
	...
	var _jeffreyrosenbluth$liarspoker$SignIn$view = function (m) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_jeffreyrosenbluth$liarspoker$SignIn$nickView(m)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_jeffreyrosenbluth$liarspoker$SignIn$joinView(m)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_jeffreyrosenbluth$liarspoker$SignIn$startView(m)
						]))
				]));
	};
	...
	var _jeffreyrosenbluth$liarspoker$Model$Model = F5(
		function (a, b, c, d, e) {
	...
	var _jeffreyrosenbluth$liarspoker$Model$subscriptions = function (model) {
		return A2(_elm_lang$websocket$WebSocket$listen, _jeffreyrosenbluth$liarspoker$Types$wsURL, _jeffreyrosenbluth$liarspoker$Model$WSincoming);
	};
	var _jeffreyrosenbluth$liarspoker$Model$ErrorMsg = function (a) {
		return {ctor: 'ErrorMsg', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$Model$JsonMsg = function (a) {
		return {ctor: 'JsonMsg', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$Model$RawMsg = function (a) {
		return {ctor: 'RawMsg', _0: a};
	};
	var _jeffreyrosenbluth$liarspoker$Model$init = {
		ctor: '_Tuple2',
		_0: {
			wsIncoming: _jeffreyrosenbluth$liarspoker$Model$RawMsg(''),
			players: _jeffreyrosenbluth$liarspoker$PlayerList$init,
			gameInfo: _jeffreyrosenbluth$liarspoker$GameInfo$init,
			gamePlay: _jeffreyrosenbluth$liarspoker$GamePlay$init,
			signIn: _jeffreyrosenbluth$liarspoker$SignIn$init
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
	...
	var _jeffreyrosenbluth$liarspoker$Update$update = F2(
		function (msg, model) {
			...
			switch (_p0.ctor) {
				case 'GamePlay':
					var _p1 = A2(_jeffreyrosenbluth$liarspoker$GamePlay$update, _p0._0, model.gamePlay);
					var gp = _p1._0;
					var cmd = _p1._1;
					return {
						ctor: '_Tuple2',
						_0: A5(_jeffreyrosenbluth$liarspoker$Model$Model, model.wsIncoming, model.players, model.gameInfo, gp, model.signIn),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _jeffreyrosenbluth$liarspoker$Model$GamePlay, cmd)
					};
				case 'SignIn':
					var _p2 = A2(_jeffreyrosenbluth$liarspoker$SignIn$update, _p0._0, model.signIn);
					var si = _p2._0;
					var cmd = _p2._1;
					return {
						ctor: '_Tuple2',
						_0: A5(_jeffreyrosenbluth$liarspoker$Model$Model, model.wsIncoming, model.players, model.gameInfo, model.gamePlay, si),
					...
					if (_elm_lang$core$Native_Utils.eq(_p4, ':signin')) {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									wsIncoming: _jeffreyrosenbluth$liarspoker$Model$RawMsg(':signin')
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						...
						if (_p3.ctor === 'Ok') {
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										wsIncoming: _jeffreyrosenbluth$liarspoker$Model$ErrorMsg(_p3._0)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						}
	...
	var _jeffreyrosenbluth$liarspoker$View$rulesView = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('m1 center blue')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('underline'),
						_elm_lang$html$Html_Attributes$target('_blank'),
						_elm_lang$html$Html_Attributes$href('http://www.liars-poker.com')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
	...
	var _jeffreyrosenbluth$liarspoker$View$previousHandView = function (c) {
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'max-width', _1: '40rem'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_jeffreyrosenbluth$liarspoker$GamePlay$view(m.gamePlay)),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_jeffreyrosenbluth$liarspoker$View$previousHandView(c),
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_jeffreyrosenbluth$liarspoker$View$rulesView
					]));
		});
	var _jeffreyrosenbluth$liarspoker$View$view = function (model) {
		var _p0 = model.wsIncoming;
		switch (_p0.ctor) {
			case 'RawMsg':
				if (_p0._0 === ':signin') {
					return A2(
						_elm_lang$html$Html_App$map,
						_jeffreyrosenbluth$liarspoker$Model$SignIn,
						_jeffreyrosenbluth$liarspoker$SignIn$view(model.signIn));
				} else {
					return A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Illegal Raw Message: ', _p0._0))
							]));
				}
			case 'JsonMsg':
	...
	var _jeffreyrosenbluth$liarspoker$Main$main = {
		main: _elm_lang$html$Html_App$program(
			{init: _jeffreyrosenbluth$liarspoker$Model$init, update: _jeffreyrosenbluth$liarspoker$Update$update, view: _jeffreyrosenbluth$liarspoker$View$view, subscriptions: _jeffreyrosenbluth$liarspoker$Model$subscriptions})
	};
